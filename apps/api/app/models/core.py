...
class Organization(Base):
    ...
    fabric_msp_id: Mapped[str | None] = mapped_column(String(120), nullable=True)
...
class User(Base):
    ...
    status: Mapped[str] = mapped_column(String(30), default="ACTIVE")
    demo_password: Mapped[str | None] = mapped_column(String(160), nullable=True)
...
class Case(Base):
    ...
    investigating_officer_id: Mapped[str | None] = mapped_column(ForeignKey("users.id"), nullable=True)
    incident_time: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    incident_location: Mapped[str | None] = mapped_column(String(250), nullable=True)
    next_hearing_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime, default=utc_now)
...
class Evidence(Base):
    ...
    capture_location: Mapped[str | None] = mapped_column(String(250), nullable=True)
    current_custodian_org_id: Mapped[str | None] = mapped_column(ForeignKey("organizations.id"), nullable=True)
...
class DocumentVersion(Base):
    ...
    fabric_tx_id: Mapped[str | None] = mapped_column(String(200), nullable=True)
...
class EvidenceCustodyEvent(Base):
    ...
    from_org_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
    to_org_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
...
class AccessGrant(Base):
    ...
    subject_org_id: Mapped[str | None] = mapped_column(ForeignKey("organizations.id"), nullable=True)
    ...
    status: Mapped[str] = mapped_column(String(30), default="ACTIVE")
    requested_scope: Mapped[str | None] = mapped_column(String(500), nullable=True)
...
class MerkleBatch(Base):
    ...
    created_at: Mapped[datetime] = mapped_column(DateTime, default=utc_now)
    public_tx_hash: Mapped[str | None] = mapped_column(String(200), nullable=True)
    public_chain_id: Mapped[str | None] = mapped_column(String(80), nullable=True)
...
class BlockchainAnchor(Base):
    ...
    contract_address: Mapped[str | None] = mapped_column(String(160), nullable=True)
